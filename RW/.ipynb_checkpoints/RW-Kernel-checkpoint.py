...
# random walk kernel
rw = {"name": 'random_walk', "with_labels": False, "lamda": 0.1, "method_type": 'fast', "kernel_type": 'geometric'}
...
for i in range(10): # 10 repeats of double cross validation
  ...
  classifierSVM = make_pipeline(
       GraphKernel(kernel=rw, normalize=True, verbose=True, random_state=seed),
